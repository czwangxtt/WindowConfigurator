...
{
    public class RemomveIntermediate : Command
    {
        static RemomveIntermediate _instance;
        public RemomveIntermediate()
        {
            _instance = this;
        }

        ///<summary>The only instance of the RemoveMullion command.</summary>
        public static RemomveIntermediate Instance
        {
        ...
        {
            get { return "RemomveIntermediate"; }
        }
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            doc.Views.Redraw();
            RhinoApp.WriteLine("The {0} command removed an intermediate in the document.", EnglishName);
